...
public class FunctionClient {
    ...
    public static void main(String[] args) throws Exception {
        ...
        props.setProperty("security-username", "guest2");
        props.setProperty("security-password", "guest2");
        ...
        String queryStr = "SELECT * FROM /customers";
         ...
         Execution ex = FunctionService.onServer(region.getRegionService());
//        ex.execute(new Function() {
//
//            public String getId() {
//                return "foo";
//            }
...
//            }
//        });
//        FunctionService functionService =FunctionService.registerFunction(null);
